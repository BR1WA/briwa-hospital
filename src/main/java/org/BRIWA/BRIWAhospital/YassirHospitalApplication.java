package org.BRIWA.BRIWAhospital;
...
import org.BRIWA.BRIWAhospital.entities.Patient;
import org.BRIWA.BRIWAhospital.repository.PatientRepository;
import org.BRIWA.BRIWAhospital.security.service.AccountService;

import java.util.Date;

@SpringBootApplication
public class BriwaHospitalApplication implements CommandLineRunner {
    @Autowired
    private PatientRepository patientRepository;

    public static void main(String[] args) {
        SpringApplication.run(BriwaHospitalApplication.class, args);
    }
...
//
//        patientRepository.save(new Patient(null,"BRIWA",new Date(),false,34));
//
